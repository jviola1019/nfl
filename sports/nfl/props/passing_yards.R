...
#'
#' @export
passing_yards_over_under <- function(simulation, line,
  ...
  # Calculate EV (push-aware, side-specific lines)
...
analyze_passing_yards_prop <- function(
  ...
  ou <- passing_yards_over_under(sim, line, over_odds, under_odds, line_over, line_under)
